  ...
  <div class="instert-bank">
    <div class="instert-bank-form">
      <ul>
        <li>
          <label>姓名</label>
          <input type="text" maxlength="21" v-model="reName" @blur="checkBankCode" placeholder="请输入姓名">
        </li>
        <li>
          <label>身份证</label>
          <input type="text" maxlength="21" v-model="ident" @blur="checkBankCode" placeholder="请输入身份证号">
        </li>
        <li>
          <label>银行卡号</label>
    ...
    <div class="insert-bank-footer">
      <div class="insert-bank-btn">
        <button :disabled="!checked" @click="submitForm">绑定收款卡</button>
      </div>
    </div>
  </div>
</template>
