...
<div class="inner-body" v-if="pageData">
  <div class="order">
    ...
    <div class="loan-msg">
      <div class="inner">
        ...
        <i class="icon" v-if="pageData.shouldRepayCount < 1"></i>
      </div>
      <div class="p3">
  ...
  <div class="list">
    <div class="list-ul">
      <template>
      <div :class="item.finished ? 'list-li dis' : 'list-li'" v-for="(item, index) in pageData.paymentSchedules" :key="index">
  ...
  <div class="footer" v-if="pageData.shouldRepayCount > 0">
